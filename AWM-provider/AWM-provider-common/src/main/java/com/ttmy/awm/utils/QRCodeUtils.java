...
public class QRCodeUtils {
    ...
    private static void insertImage(BufferedImage source, String imgPath,
        ...
        if (!file.exists()) {
            System.err.println(""+imgPath+"   ----NO LOGO FILE---->");
            return;
        }
     ...
     * @throws Exception
     */
    public byte[] encode(String content, String imgPath,
    ...
    public static void encode(String content, OutputStream output)
            throws Exception {
        new QRCodeUtils().encode(content, null, output, false);
    }
